...
try {
	...
	DbHandler.addStudent(Integer.parseInt(rno), name, Integer.parseInt(marks1), Integer.parseInt(marks2), Integer.parseInt(marks3));
	reset();
}
...
setVisible(true);
c.setBackground(new Color(180, 177, 233));
